...
var app = (function () {
    ...
    ***************************************************************************** */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 99, 1, 2085);
    			add_location(button, file$1, 100, 1, 2129);
    			add_location(main, file$1, 97, 0, 2064);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*startReserveTree*/ ctx[2], false, false, false)
    				];
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<InvertBinaryTree> was created with unknown prop '${key}'`);
    	});
    	...
    	return [inputTree, tree, startReserveTree, input_input_handler];
    }
    ...
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(12:4) <Link to=\\\"/find-primes\\\">",
    		ctx
    	});
    ...
    // (13:4) <Link to="/invert-binary-tree">
    function create_default_slot_1(ctx) {
    	let t;

    	const block = {
    		c: function create() {
    			t = text("Invert Binary Tree");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, t, anchor);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(13:4) <Link to=\\\"/invert-binary-tree\\\">",
    		ctx
    	});
    ...
    function create_default_slot(ctx) {
    	...
    	route2 = new Route({
    			props: { path: "*", component: FindPrimes },
    			$$inline: true
    		});
