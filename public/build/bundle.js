...
var app = (function () {
    ...
    const file$6 = "src/components/TheNav.svelte";
    ...
    ***************************************************************************** */
    ...
    const file$5 = "src/routes/FindPrimes.svelte";
    ...
    function create_each_block$4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$5, 79, 4, 1630);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$5, 77, 0, 1587);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*primes, nowSettingNumber, nowColor*/ 7) {
    				...
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$4, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, main, outro_and_destroy_block, create_each_block$4, null, get_each_context$4);
    				check_outros();
    			}
    		},
    		i: function intro(local) {
    ...
    const file$4 = "src/routes/InvertBinaryTree/Node.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
			...
			: "#717171"}
    			...
    			add_location(div0, file$4, 47, 2, 839);
    			attr_dev(div1, "class", "node__child svelte-fa4uwv");
    			add_location(div1, file$4, 63, 2, 1240);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$3(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$4, 41, 0, 759);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$3 = "src/routes/InvertBinaryTree/index.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$3, 112, 1, 2494);
    			add_location(button, file$3, 113, 1, 2538);
    			add_location(main, file$3, 110, 0, 2473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/routes/Sorting/components/Insertion.svelte";
    ...
    function create_each_block$2(key_2, ctx) {
      ...
      `);
    			...
    			add_location(div, file$2, 52, 4, 1033);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 50, 0, 968);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/routes/Sorting/components/Selection.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
        ...
        `);
    			...
    			add_location(div, file$1, 57, 6, 1179);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 55, 2, 1114);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file = "src/routes/Sorting/components/Bubble.svelte";
    ...
    function create_each_block(key_1, ctx) {
        ...
        `);
    			...
    			add_location(div, file, 52, 6, 1079);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-rc0agl");
    			add_location(div, file, 50, 2, 1014);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Insertion, Selection, Bubble });
    	return [];
    }
