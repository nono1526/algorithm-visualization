...
var app = (function () {
    ...
    const file$8 = "src/components/TheNav.svelte";
    ...
    ***************************************************************************** */
    ...
    const file$7 = "src/routes/FindPrimes.svelte";
    ...
    function create_each_block$6(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$7, 79, 4, 1630);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$7, 77, 0, 1587);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$6 = "src/routes/InvertBinaryTree/Node.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
			...
			: "#717171"}
    			...
    			add_location(div0, file$6, 47, 2, 839);
    			attr_dev(div1, "class", "node__child svelte-fa4uwv");
    			add_location(div1, file$6, 63, 2, 1240);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$5(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$6, 41, 0, 759);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$5 = "src/routes/InvertBinaryTree/index.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$5, 112, 1, 2494);
    			add_location(button, file$5, 113, 1, 2538);
    			add_location(main, file$5, 110, 0, 2473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/routes/Sorting/components/Insertion.svelte";
    ...
    const file$3 = "src/routes/Sorting/components/Selection.svelte";
    ...
    const file$2 = "src/routes/Sorting/components/Bubble.svelte";
    ...
    const file$1 = "src/routes/Sorting/components/Quick.svelte";
    ...
    const file = "src/routes/Sorting/components/Shell.svelte";
