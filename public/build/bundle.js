...
var app = (function () {
    ...
    const file$4 = "src/components/TheNav.svelte";
    ...
    ***************************************************************************** */
    ...
    const file$3 = "src/routes/FindPrimes.svelte";
    ...
    function create_each_block$2(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$3, 79, 4, 1630);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$3, 77, 0, 1587);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*primes, nowSettingNumber, nowColor*/ 7) {
    				...
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context$2, get_key);
    				each_blocks = update_keyed_each(each_blocks, dirty, get_key, 1, ctx, each_value, each_1_lookup, main, outro_and_destroy_block, create_each_block$2, null, get_each_context$2);
    				check_outros();
    			}
    		},
    		i: function intro(local) {
    ...
    const file$2 = "src/routes/InvertBinaryTree/Node.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
			...
			: "#717171"}
    			...
    			add_location(div0, file$2, 47, 2, 839);
    			attr_dev(div1, "class", "node__child svelte-fa4uwv");
    			add_location(div1, file$2, 63, 2, 1240);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$2, 41, 0, 759);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$1 = "src/routes/InvertBinaryTree/index.svelte";
    ...
    const file = "src/routes/Sorting/components/Insertion.svelte";
    ...
    function create_each_block(key_2, ctx) {
      ...
      `);
    			...
    			add_location(div, file, 52, 4, 1033);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 50, 0, 968);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
