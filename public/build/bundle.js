...
var app = (function () {
    ...
    const file$7 = "src/components/TheNav.svelte";
    ...
    ***************************************************************************** */
    ...
    const file$6 = "src/routes/FindPrimes.svelte";
    ...
    function create_each_block$5(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$6, 79, 4, 1630);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$6, 77, 0, 1587);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "src/routes/InvertBinaryTree/Node.svelte";
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
			...
			: "#717171"}
    			...
    			add_location(div0, file$5, 47, 2, 839);
    			attr_dev(div1, "class", "node__child svelte-fa4uwv");
    			add_location(div1, file$5, 63, 2, 1240);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$4(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$5, 41, 0, 759);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$4 = "src/routes/InvertBinaryTree/index.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 112, 1, 2494);
    			add_location(button, file$4, 113, 1, 2538);
    			add_location(main, file$4, 110, 0, 2473);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$3 = "src/routes/Sorting/components/Insertion.svelte";
    ...
    function create_each_block$3(key_2, ctx) {
      ...
      `);
    			...
    			add_location(div, file$3, 52, 4, 1033);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 50, 0, 968);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$2 = "src/routes/Sorting/components/Selection.svelte";
    ...
    function create_each_block$2(key_1, ctx) {
        ...
        `);
    			...
    			add_location(div, file$2, 57, 6, 1179);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 55, 2, 1114);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$1 = "src/routes/Sorting/components/Bubble.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
        ...
        `);
    			...
    			add_location(div, file$1, 52, 6, 1079);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-rc0agl");
    			add_location(div, file$1, 50, 2, 1014);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file = "src/routes/Sorting/components/Quick.svelte";
    ...
    function create_each_block(key_1, ctx) {
        ...
        `);
    			...
    			add_location(div, file, 70, 6, 1427);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "wrapper svelte-rc0agl");
    			add_location(div, file, 68, 2, 1358);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Insertion, Selection, Bubble, Quick });
    	return [];
    }
